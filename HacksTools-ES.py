...
def imprimir_herramientas():
    herramientas = [
        ...
        "4 - Gobuster (Fuerza Bruta de Directorios y Subdominios)",
        "5 - Hydra (Herramienta de Ataque por Fuerza Bruta)",
        "6 - Sqlmap (Automatización de Inyecciones SQL)",
        "7 - John the Ripper (Descifrado de Contraseñas)",
        "8 - Wireshark (Analizador de Protocolos de Red)",
        "9 - Aircrack-ng (Descifrado de Wi-Fi)",
        "10 - Nikto (Escáner de Vulnerabilidades de Servidores Web)",
        "11 - Recon-ng (Framework de Reconocimiento Web)",
        "12 - LinEnum (Enumeración de Escalamiento de Privilegios)",
        "13 - Wifite (Descifrado Inalámbrico Automatizado)",
        "14 - Mimikatz (Volcado de Credenciales de Windows)",
        "15 - BloodHound (Enumeración de Active Directory)",
        "16 - OWASP ZAP (Pruebas de Seguridad de Aplicaciones Web)",
        "17 - BeEF (Framework de Explotación de Navegadores)",
        "18 - Social Engineering Toolkit (Phishing y Ingeniería Social)",
        "19 - Gobuster (Fuerza Bruta DNS y Directorios)",
        "20 - Sublist3r (Enumeración de Subdominios)",
        "21 - Hashcat (Descifrado de Contraseñas)",
        "22 - TheHarvester (Recolección de Correos Electrónicos y Dominios)",
        "23 - SpiderFoot (Reconocimiento Automatizado)",
        ...
        "27 - Netcat (Utilidad de Red y Reverse Shell)",
        ...
        "33 - Fsociety (Kit de Herramientas Todo-en-Uno para Hackers)",
        ...
        "46 - Dirbuster (Fuerza Bruta de Directorios)",
        "47 - Moxie0 (Ataque de Downgrade HTTPS SSLStrip)",
        "48 - PrivescCheck (Comprobador de Escalamiento de Privilegios)",
        "49 - Ghost Phisher (Phishing Wi-Fi y Ataques)",
...
def instalar_herramienta(numero_herramienta):
    ...
    if numero_herramienta < 1 or numero_herramienta > 50:
        print(Fore.RED + "Opción no válida. Por favor, selecciona un número entre 1 y 50.")
        return

    nombre_herramienta = list(enlaces_herramientas.keys())[numero_herramienta - 1]
    url_herramienta = enlaces_herramientas[nombre_herramienta]

    # Clonar o descargar el repositorio desde GitHub
    print(Fore.YELLOW + f"\nDescargando herramienta: {nombre_herramienta}")
    subprocess.run(["git", "clone", url_herramienta])

def principal():
    print(Fore.YELLOW + Style.BRIGHT + "\n=================== Herramientas de Hackeo ====================")
    print(Fore.RED + Style.BRIGHT + "¡Bienvenido a Hackstools - El Kit de Herramientas Definitivo para Hackers!\n")
